...
// import {FormValidator} from '../../../../../FormValidator/form-validator';


@Component({
  selector: 'app-setting1',
  templateUrl: './setting1.component.html',
  styleUrls: ['./setting1.component.scss']
})
export class Setting1Component {
  ...
  {
    this.emitLoading(true);
    this.college_typeService.deleteCollege_type(this.college_typeid,this.UserForm.value).subscribe((res)=>{
      this.GetCollege_types();
      this.modalService.dismissAll();
      this.emitLoading(false);
      this.emitAlert('alert-danger','College type deleted successfully.');
    });
  }
